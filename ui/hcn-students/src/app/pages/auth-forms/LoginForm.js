		...
		<div className='auth-wrapper'>
			<div className='auth-inner-login'>
				...
				<Form className='auth-form'>
					...
					<Form.Group>
						<OverlayTrigger placement='right' overlay={<Tooltip id='button-tooltip-2'>Sólo se aceptan correos con el formato @javerianacali.edu.co</Tooltip>} transition={false}>
							{({ref, ...triggerHandler}) => (
								<div
									variant='none'
									style={{
